...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalEachItem.setText(String.valueOf(Math.round((productDomains.get(position).getNumberIncard() * productDomains.get(position).getFee()) * 100.0) / 100.0));
        holder.num.setText(String.valueOf(productDomains.get(position).getNumberIncard()));
        ...
        holder.plusItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cartManagement.plusNumberProduct(productDomains, position, new ChangeNumberItemsListener() {
                    @Override
                    public void changed() {
        ...
        holder.minusItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cartManagement.MinusNumerProduct(productDomains, position, new ChangeNumberItemsListener() {
                    @Override
                    public void changed() {
                        notifyDataSetChanged();
                        changeNumberItemsListener.changed();
